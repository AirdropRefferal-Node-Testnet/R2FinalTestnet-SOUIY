...
function updateWelcomeBox() {
  const botVersion = "FOLLOW TIKTOK : AirdropRefferal (Souiy1)";
  const content = `{center}{bold}{bright-red-fg}[:: R2 :: AUTO :: BOT ::]{/bright-red-fg}{/bold}{/center}\n\n` +
    `{center}{bold}{bright-yellow-fg}JANGAN LUPA : ${botVersion}{/bright-yellow-fg}{/bold}{/center}\n` +
    `{center}{bold}{bright-cyan-fg}➥ Satukan Solidaritas Bantu Palestina!{/bright-cyan-fg}{/bold}{/center}\n` +
    `{center}{bold}{bright-cyan-fg}➥ https://digital.dompetdhuafa.org/donasi/jagapalestina{/bright-cyan-fg}{/bold}{/center}\n` +
    `{center}{bold}{grey-fg}GASSKEN{/grey-fg}{/bold}{/center}\n`;
...
safeRender();
mainMenu.focus();
addLog("Dont Forget To FOLLOW TIKTOK : AirdropRefferal (@Souiy1)!!", "system");
updateWelcomeBox();